...
const missions = [
  {
    ...
    "hints": [
      "Usá console.log('...')",
      "El mensaje debe ser 'CONEXIÓN_ESTABLECIDA'."
    ],
  ...
  },
  {
    ...
    "hints": [
      "switch(prioridad) { case 'ALTA': activarAlerta(); break; ... }"
    ],
  ...
  },
  {
    ...
    "hints": [
      "while (energia < 100 && calor < 50) { energia++; calor += 2; }"
    ],
  ...
  },
  {
    ...
    "hints": [
      "function canJump(fuel, hull) { return fuel > 80 || hull > 50; }"
    ],
  ...
  },
  {
    ...
    "hints": [
      "btn.addEventListener('click', () => { if(STATE.energy < 20) alert('BATERÍA_BAJA'); });"
    ],
  ...
  },
  {
    ...
    "hints": [
      "const d = document.createElement('div'); d.className = 'hud-card'; document.body.appendChild(d);"
    ],
  ...
  },
  {
    ...
    "hints": [
      "fetch('URL').then(r => r.json()).catch(e => console.log('FALLO_RED'));"
    ],
  ...
  },
  {
    ...
    "hints": [
      "async function boot() { await fetch(...); console.log('KERNEL_LISTO'); }"
    ],
  ...
  },
  {
    ...
    "hints": [
      "getData: () => secret, setData: (v) => secret = v"
    ],
  ...
  },
  {
    ...
    "hints": [
      "class Starship { constructor(name) { this.name = name; } thrust() { console.log('IGNICIÓN'); } }"
    ],
  ...
  },
  {
    ...
    "hints": [
      "static isValid(code) { return code.length > 5; }"
    ],
  ...
  },
  {
    ...
    "hints": [
      "const signals = new Map(); signals.set('Europa', 1500);"
    ],
  ...
  },
  {
    ...
    "hints": [
      "new Proxy(settings, { set: (obj, prop, val) => { console.log('CONFIG_LOCKED'); return true; } });"
    ],
  ...
  },
  {
    ...
    "hints": [
      "if (energia === 0) throw new SystemError('CRITICAL');"
    ],
  ...
  },
  {
    ...
    "hints": [
      "class Kernel { async init() { await fetch(...); console.log('STARK_OS_RESTABLECIDO'); } }"
    ],
